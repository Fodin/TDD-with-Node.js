...
const postUser = (user = validUser) => {
  return req(app).post('/api/1.0/users').send(user);
};
...
describe('User registration', () => {
  ...
  it.each`
    ...
    ${'username'} | ${'usr'}           | ${'Must have min 4 and max 32 chars'}
    ${'username'} | ${'a'.repeat(33)}  | ${'Must have min 4 and max 32 chars'}
    ...
    ${'password'} | ${'pass'}          | ${'Password must be at least 6 chars'}
    ...
    ${'password'} | ${'123456'}        | ${'Password must have at least 1 uppercase, 1 lowercase and 1 number'}
    ${'password'} | ${'lowerandUpper'} | ${'Password must have at least 1 uppercase, 1 lowercase and 1 number'}
    ${'password'} | ${'lowerand1234'}  | ${'Password must have at least 1 uppercase, 1 lowercase and 1 number'}
